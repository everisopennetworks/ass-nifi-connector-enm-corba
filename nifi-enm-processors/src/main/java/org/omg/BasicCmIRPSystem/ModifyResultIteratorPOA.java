...
/**
* org.omg.BasicCmIRPSystem/ModifyResultIteratorPOA.java .
...
/**
     ...
     */
public abstract class ModifyResultIteratorPOA extends org.omg.PortableServer.Servant
 implements ModifyResultIteratorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("next_modificationErrors", new Integer (0));
  ...
  /**
        ...
        */
       case 0:  // org.omg.BasicCmIRPSystem/ModifyResultIterator/next_modificationErrors
       {
         try {
           short how_many = in.read_ushort ();
           org.omg.BasicCMIRPConstDefs.ModifyAttributeErrorsSeqHolder fetchedModifyErrors = new org.omg.BasicCMIRPConstDefs.ModifyAttributeErrorsSeqHolder ();
           boolean $result = false;
           $result = this.next_modificationErrors (how_many, fetchedModifyErrors);
           out = $rh.createReply();
           out.write_boolean ($result);
           org.omg.BasicCMIRPConstDefs.ModifyAttributeErrorsSeqHelper.write (out, fetchedModifyErrors.value);
         } catch (NextModifyErrors $ex) {
           out = $rh.createExceptionReply ();
           NextModifyErrorsHelper.write (out, $ex);
  ...
  public ModifyResultIterator _this() 
  {
    return ModifyResultIteratorHelper.narrow(
    super._this_object());
  }

  public ModifyResultIterator _this(org.omg.CORBA.ORB orb) 
  {
    return ModifyResultIteratorHelper.narrow(
