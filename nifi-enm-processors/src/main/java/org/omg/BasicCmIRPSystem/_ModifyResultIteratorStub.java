...
/**
* org.omg.BasicCmIRPSystem/_ModifyResultIteratorStub.java .
...
/**
     ...
     */
public class _ModifyResultIteratorStub extends org.omg.CORBA.portable.ObjectImpl implements ModifyResultIterator
{
  ...
  /**
        ...
        */
  public boolean next_modificationErrors (short how_many, org.omg.BasicCMIRPConstDefs.ModifyAttributeErrorsSeqHolder fetchedModifyErrors) throws NextModifyErrors, org.omg.ManagedGenericIRPSystem.InvalidParameter
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("next_modificationErrors", true);
                $out.write_ushort (how_many);
                $in = _invoke ($out);
                boolean $result = $in.read_boolean ();
                fetchedModifyErrors.value = org.omg.BasicCMIRPConstDefs.ModifyAttributeErrorsSeqHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:3gppsa5.org/BasicCmIRPSystem/NextModifyErrors:1.0"))
                    throw NextModifyErrorsHelper.read ($in);
                ...
                return next_modificationErrors (how_many, fetchedModifyErrors        );
            } finally {
                _releaseReply ($in);
            }
  } // next_modificationErrors
  ...
  private static String[] __ids = {
    "IDL:3gppsa5.org/BasicCmIRPSystem/ModifyResultIterator:1.0",
...
} // class _ModifyResultIteratorStub
