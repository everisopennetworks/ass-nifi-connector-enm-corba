...
/**
* org.omg.GenericIRPManagementConstDefs/UnsignedShortOptHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from org.omg.GenericIRPManagementConstDefs.idl
* jueves 5 de septiembre de 2019 02:18:41 AM CDT
*/

abstract public class UnsignedShortOptHelper
{
  private static String  _id = "IDL:3gppsa5.org/GenericIRPManagementConstDefs/UnsignedShortOpt:1.0";

  public static void insert (org.omg.CORBA.Any a, UnsignedShortOpt that)
  {
  ...
  public static UnsignedShortOpt extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      _members0[0] = new org.omg.CORBA.UnionMember (
        ...
        _tcOf_members0,
        null);
      __typeCode = org.omg.CORBA.ORB.init ().create_union_tc (UnsignedShortOptHelper.id (), "UnsignedShortOpt", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static UnsignedShortOpt read (org.omg.CORBA.portable.InputStream istream)
  {
    UnsignedShortOpt value = new UnsignedShortOpt ();
    boolean _dis0 = false;
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, UnsignedShortOpt value)
  {
