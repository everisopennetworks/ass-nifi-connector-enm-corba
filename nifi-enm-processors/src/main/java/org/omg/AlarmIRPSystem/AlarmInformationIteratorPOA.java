...
/**
* org.omg.AlarmIRPSystem/AlarmInformationIteratorPOA.java .
...
public abstract class AlarmInformationIteratorPOA extends org.omg.PortableServer.Servant
 implements AlarmInformationIteratorOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("next_alarmInformations", new Integer (0));
  ...
  /*
      ...
      iterator.
      */
       case 0:  // org.omg.AlarmIRPSystem/AlarmInformationIterator/next_alarmInformations
       {
         try {
           ...
           org.omg.AlarmIRPConstDefs.AlarmInformationSeqHelper.write (out, alarm_informations.value);
         } catch (NextAlarmInformations $ex) {
           out = $rh.createExceptionReply ();
           NextAlarmInformationsHelper.write (out, $ex);
  ...
  /*
      ...
      */
       case 1:  // org.omg.AlarmIRPSystem/AlarmInformationIterator/destroy
       {
         this.destroy ();
         out = $rh.createReply();
         break;
