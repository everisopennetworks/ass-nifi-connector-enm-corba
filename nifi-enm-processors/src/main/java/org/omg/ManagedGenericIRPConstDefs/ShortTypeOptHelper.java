...
/**
* org.omg.ManagedGenericIRPConstDefs/ShortTypeOptHelper.java .
...
abstract public class ShortTypeOptHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, ShortTypeOpt that)
  {
  ...
  public static ShortTypeOpt extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      _members0[0] = new org.omg.CORBA.UnionMember (
        ...
        _tcOf_members0,
        null);
      __typeCode = org.omg.CORBA.ORB.init ().create_union_tc (ShortTypeOptHelper.id (), "ShortTypeOpt", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static ShortTypeOpt read (org.omg.CORBA.portable.InputStream istream)
  {
    ShortTypeOpt value = new ShortTypeOpt ();
    boolean _dis0 = false;
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, ShortTypeOpt value)
  {
