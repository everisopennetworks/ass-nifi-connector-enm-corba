...
/**
* org.omg.ManagedGenericIRPConstDefs/LongTypeOptHelper.java .
...
abstract public class LongTypeOptHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, LongTypeOpt that)
  {
  ...
  public static LongTypeOpt extract (org.omg.CORBA.Any a)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      _members0[0] = new org.omg.CORBA.UnionMember (
        ...
        _tcOf_members0,
        null);
      __typeCode = org.omg.CORBA.ORB.init ().create_union_tc (LongTypeOptHelper.id (), "LongTypeOpt", _disTypeCode0, _members0);
    }
    return __typeCode;
  }
  ...
  public static LongTypeOpt read (org.omg.CORBA.portable.InputStream istream)
  {
    LongTypeOpt value = new LongTypeOpt ();
    boolean _dis0 = false;
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, LongTypeOpt value)
  {
