...
/**
* org.omg.CSIRPConstDefs/HeartbeatPeriodTypeHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from org.omg.CSIRPConstDefs.idl
* jueves 5 de septiembre de 2019 02:16:49 AM CDT
*/

abstract public class HeartbeatPeriodTypeHelper
{
  private static String  _id = "IDL:3gppsa5.org/CSIRPConstDefs/HeartbeatPeriodType:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (HeartbeatPeriodTypeHelper.id (), "HeartbeatPeriodType", __typeCode);
    }
    return __typeCode;
  }
