...
/**
* org.omg.BasicCMIRPConstDefs/ResultSetHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from org.omg.BasicCMIRPConstDefs.idl
* jueves 5 de septiembre de 2019 02:15:01 AM CDT
*/

abstract public class ResultSetHelper
{
  private static String  _id = "IDL:3gppsa5.org/BasicCMIRPConstDefs/ResultSet:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = ResultHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (ResultSetHelper.id (), "ResultSet", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static Result[] read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = new Result[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = ResultHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, Result[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      ResultHelper.write (ostream, value[_i0]);
  }
