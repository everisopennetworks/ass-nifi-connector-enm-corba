...
/**
* org.omg.KernelCmNotifications/NotificationCommonPOA.java .
...
/**
       ...
       */
public abstract class NotificationCommonPOA extends org.omg.PortableServer.Servant
 implements NotificationCommonOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public NotificationCommon _this() 
  {
    return NotificationCommonHelper.narrow(
    super._this_object());
  }

  public NotificationCommon _this(org.omg.CORBA.ORB orb) 
  {
    return NotificationCommonHelper.narrow(
