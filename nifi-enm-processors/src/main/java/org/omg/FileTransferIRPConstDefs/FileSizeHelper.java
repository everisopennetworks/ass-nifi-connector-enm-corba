...
/**
* org.omg.FileTransferIRPConstDefs/FileSizeHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from org.omg.FileTransferIRPConstDefs.idl
* jueves 5 de septiembre de 2019 02:17:31 AM CDT
*/

abstract public class FileSizeHelper
{
  private static String  _id = "IDL:3gppsa5.org/FileTransferIRPConstDefs/FileSize:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (FileSizeHelper.id (), "FileSize", __typeCode);
    }
    return __typeCode;
  }
