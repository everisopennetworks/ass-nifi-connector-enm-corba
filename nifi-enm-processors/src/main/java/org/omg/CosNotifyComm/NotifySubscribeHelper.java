...
/**
* org.omg.CosNotifyComm/NotifySubscribeHelper.java .
...
abstract public class NotifySubscribeHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, NotifySubscribe that)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (NotifySubscribeHelper.id (), "NotifySubscribe");
    }
    return __typeCode;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, NotifySubscribe value)
  {
  ...
  public static NotifySubscribe narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof NotifySubscribe)
      return (NotifySubscribe)obj;
    else if (!obj._is_a (id ()))
      throw new org.omg.CORBA.BAD_PARAM ();
    else
    {
      org.omg.CORBA.portable.Delegate delegate = ((org.omg.CORBA.portable.ObjectImpl)obj)._get_delegate ();
      _NotifySubscribeStub stub = new _NotifySubscribeStub ();
