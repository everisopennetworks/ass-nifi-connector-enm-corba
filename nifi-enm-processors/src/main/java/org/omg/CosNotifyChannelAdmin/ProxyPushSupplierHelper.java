...
/**
* org.omg.CosNotifyChannelAdmin/ProxyPushSupplierHelper.java .
...
abstract public class ProxyPushSupplierHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, ProxyPushSupplier that)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (ProxyPushSupplierHelper.id (), "ProxyPushSupplier");
    }
    return __typeCode;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, ProxyPushSupplier value)
  {
  ...
  public static ProxyPushSupplier narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof ProxyPushSupplier)
