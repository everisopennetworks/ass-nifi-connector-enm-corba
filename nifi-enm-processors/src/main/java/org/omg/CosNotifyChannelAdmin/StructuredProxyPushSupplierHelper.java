...
/**
* org.omg.CosNotifyChannelAdmin/StructuredProxyPushSupplierHelper.java .
...
abstract public class StructuredProxyPushSupplierHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, StructuredProxyPushSupplier that)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (StructuredProxyPushSupplierHelper.id (), "StructuredProxyPushSupplier");
    }
    return __typeCode;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, StructuredProxyPushSupplier value)
  {
  ...
  public static StructuredProxyPushSupplier narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof StructuredProxyPushSupplier)
      return (StructuredProxyPushSupplier)obj;
    else if (!obj._is_a (id ()))
      throw new org.omg.CORBA.BAD_PARAM ();
    else
    {
      org.omg.CORBA.portable.Delegate delegate = ((org.omg.CORBA.portable.ObjectImpl)obj)._get_delegate ();
      _StructuredProxyPushSupplierStub stub = new _StructuredProxyPushSupplierStub ();
