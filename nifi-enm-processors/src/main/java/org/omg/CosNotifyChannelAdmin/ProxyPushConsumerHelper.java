...
/**
* org.omg.CosNotifyChannelAdmin/ProxyPushConsumerHelper.java .
...
abstract public class ProxyPushConsumerHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, ProxyPushConsumer that)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (ProxyPushConsumerHelper.id (), "ProxyPushConsumer");
    }
    return __typeCode;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, ProxyPushConsumer value)
  {
  ...
  public static ProxyPushConsumer narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      return null;
    else if (obj instanceof ProxyPushConsumer)
