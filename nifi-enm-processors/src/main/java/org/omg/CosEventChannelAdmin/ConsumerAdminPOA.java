...
/**
* org.omg.CosEventChannelAdmin/ConsumerAdminPOA.java .
 ...
 implements ConsumerAdminOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("obtain_push_supplier", new Integer (0));
    _methods.put ("obtain_pull_supplier", new Integer (1));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // org.omg.CosEventChannelAdmin/ConsumerAdmin/obtain_push_supplier
       {
         ProxyPushSupplier $result = null;
         $result = this.obtain_push_supplier ();
         out = $rh.createReply();
         ProxyPushSupplierHelper.write (out, $result);
         break;
       }

       case 1:  // org.omg.CosEventChannelAdmin/ConsumerAdmin/obtain_pull_supplier
       {
         ProxyPullSupplier $result = null;
         $result = this.obtain_pull_supplier ();
         out = $rh.createReply();
         ProxyPullSupplierHelper.write (out, $result);
         break;
       }
