...
/**
* org.omg.CosEventChannelAdmin/ProxyPullSupplierPOA.java .
 ...
 implements ProxyPullSupplierOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("connect_pull_consumer", new Integer (0));
    _methods.put ("pull", new Integer (1));
    _methods.put ("try_pull", new Integer (2));
    _methods.put ("disconnect_pull_supplier", new Integer (3));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // org.omg.CosEventChannelAdmin/ProxyPullSupplier/connect_pull_consumer
       {
         try {
       ...
       case 1:  // org.omg.CosEventComm/PullSupplier/pull
       {
         try {
       ...
       case 2:  // org.omg.CosEventComm/PullSupplier/try_pull
       {
         try {
       ...
       case 3:  // org.omg.CosEventComm/PullSupplier/disconnect_pull_supplier
       {
