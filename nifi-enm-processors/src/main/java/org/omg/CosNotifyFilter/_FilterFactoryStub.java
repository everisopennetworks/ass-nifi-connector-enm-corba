...
/**
* org.omg.CosNotifyFilter/_FilterFactoryStub.java .
...
// MappingFilter
public class _FilterFactoryStub extends org.omg.CORBA.portable.ObjectImpl implements FilterFactory
{
  ...
  public Filter create_filter (String constraint_grammar) throws InvalidGrammar
  {
            ...
            try {
                ...
                if (_id.equals ("IDL:omg.org/CosNotifyFilter/InvalidGrammar:1.0"))
                    throw InvalidGrammarHelper.read ($in);
                else
  ...
  public MappingFilter create_mapping_filter (String constraint_grammar, org.omg.CORBA.Any default_value) throws InvalidGrammar
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = _invoke ($out);
                MappingFilter $result = MappingFilterHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
