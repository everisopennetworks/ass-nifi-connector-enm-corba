...
/**
* org.omg.CosNotifyFilter/FilterFactoryHelper.java .
...
abstract public class FilterFactoryHelper
{
  ...
  public static void insert (org.omg.CORBA.Any a, FilterFactory that)
  {
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = org.omg.CORBA.ORB.init ().create_interface_tc (FilterFactoryHelper.id (), "FilterFactory");
    }
    return __typeCode;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, FilterFactory value)
  {
  ...
  public static FilterFactory narrow (org.omg.CORBA.Object obj)
  {
    if (obj == null)
      ...
      return (FilterFactory)obj;
    else if (!obj._is_a (id ()))
      throw new org.omg.CORBA.BAD_PARAM ();
    else
    {
      org.omg.CORBA.portable.Delegate delegate = ((org.omg.CORBA.portable.ObjectImpl)obj)._get_delegate ();
      _FilterFactoryStub stub = new _FilterFactoryStub ();
